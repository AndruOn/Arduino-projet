#---------------------------------------------------------
# Print list of serial_ports
# also contains list of turtle colors
#---------------------------------------------------------
...
color_list=['palegoldenrod', 'lightgoldenrodyellow',
    ...
    'coral', 'lightcoral', 'tomato', 'orangered', 'red']
color= ['snow', 'ghostwhite', 'whitesmoke', 'gainsboro', 'floralwhite', 'oldlace',
...
for i in range(1,40):
    ...
    tuple=(turtle.setpos(p,q), turtle.pd(), turtle.color(colors),
           turtle.dot(10+i/50),turtle.rt(i), turtle.forward(20+10*i),turtle.pensize(s))
